...
def deploy_contract_ctor(compiled_contract: Path, ctor_args: tuple):
    env = '8b91220f00fb409feae967f1e9e5884f68bff7cc022ee0bcab3bedb0804e169e' #EnvPrivateKey("ZKSYNC_TEST_KEY")
...
if __name__ == "__main__":
    vccu = '0xC04d245263fF5459CeA78C1800fdc69BD11B4b59'
    contract = Path("../artifacts-zk/contracts/UniswapV2Factory.sol/UniswapV2Factory.json")
    args = (vccu)
